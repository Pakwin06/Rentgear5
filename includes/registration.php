  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
          ...
          <div class="signup_wrap">
            <div class="col-md-12 col-sm-6">
              <form method="post" name="signup" onSubmit="return valid();">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="mobileno" placeholder="Nomor Seluler" maxlength="10" required="required">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="password" class="form-control" name="confirmpassword" placeholder="Konfirmasi Kata Sandi" required="required">
                </div>
      ...
      <div class="modal-footer text-center">
        <p>Sudah punya akun? <a href="#loginform" data-toggle="modal" data-dismiss="modal">Masuk Disini</a></p>
      </div>
    </div>
  </div>
</div>